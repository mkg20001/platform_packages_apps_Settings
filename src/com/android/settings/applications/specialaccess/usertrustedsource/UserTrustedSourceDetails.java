...
package com.android.settings.applications.specialaccess.usertrustedsource;
...
public class UserTrustedSourceDetails extends AppInfoWithHeader implements
        UserTrustedSourceSettingObserverMixin.Listener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSettingsLifecycle().addObserver(
                new UserTrustedSourceSettingObserverMixin(getContext(), this /* listener */));
    }
    ...
    protected boolean refreshUi() {
        ...
        final Set<String> needAccessApps =
                UserTrustedSourceController.getPackagesRequestingNotificationPolicyAccess();
    ...
    private void updatePreference(Context context, TwoStatePreference preference) {
        ...
        final Set<String> autoApproved = UserTrustedSourceController.getAutoApprovedPackages(context);
        ...
        preference.setChecked(UserTrustedSourceController.hasAccess(context, mPackageName));
        preference.setOnPreferenceChangeListener((p, newValue) -> {
            final boolean access = (Boolean) newValue;
            if (access) {
                new ScaryWarningDialogFragment()
                        .setPkgInfo(mPackageName, label, UserTrustedSourceDetails.this)
