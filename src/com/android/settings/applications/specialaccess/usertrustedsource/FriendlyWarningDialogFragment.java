...
public class FriendlyWarningDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        UserTrustedSourceDetails
                parent = (UserTrustedSourceDetails) getTargetFragment();
        return new AlertDialog.Builder(getContext())
                ...
                .setPositiveButton(R.string.okay,
                        (dialog, id) -> {
                            UserTrustedSourceController.deleteRules(getContext(), pkg);
                            UserTrustedSourceController.setAccess(getContext(), pkg, false);
                            parent.refreshUi();
                        })
