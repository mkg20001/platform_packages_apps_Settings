...
public class Force5gPreferenceController extends TelephonyTogglePreferenceController {
     ...
     */
    public Force5gPreferenceController(Context context, String key) {
        super(context, key);
     ...
     */
    public Force5gPreferenceController init(int subId) {
        mSubId = subId;
    ...
    public void updateState(Preference preference) {
        ...
        /* Settings.Global.getInt(mContext.getContentResolver(),
                Settings.Global.MOBILE_DATA_FORCE_5G, 1) != 0; */
    ...
    /**
     * Get the {@link AvailabilityStatus} for
    ...
    public boolean setChecked(boolean isChecked) {
        ...
        long currentlyAllowedNetworkTypes = mTelephonyManager.getAllowedNetworkTypesForReason(
                mTelephonyManager.ALLOWED_NETWORK_TYPES_REASON_USER);
        boolean enabled = (currentlyAllowedNetworkTypes & BITMASK_5G) != 0;
        /*if (enabled == isChecked) {
            return false;
        }*/
        long newAllowedNetworkTypes = currentlyAllowedNetworkTypes;
        if (isChecked) {
            newAllowedNetworkTypes = currentlyAllowedNetworkTypes | BITMASK_5G;
            Log.i(LOG_TAG, "Enabling 5g. Allowed network types: " + newAllowedNetworkTypes);
        } else {
            newAllowedNetworkTypes = currentlyAllowedNetworkTypes & ~BITMASK_5G;
            Log.i(LOG_TAG, "Disabling 5g. Allowed network types: " + newAllowedNetworkTypes);
        }
        mTelephonyManager.setAllowedNetworkTypesForReason(
                mTelephonyManager.ALLOWED_NETWORK_TYPES_REASON_USER, newAllowedNetworkTypes);
